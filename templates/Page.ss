...
<head>
  ...
  <!-- Bootstrap 3.3.7 -->
  <link rel="stylesheet" href="{$ThemeDir}/bootstrap/css/bootstrap.min.css">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.5.0/css/font-awesome.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ionicons/2.0.1/css/ionicons.min.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="{$ThemeDir}/dist/css/AdminLTE.min.css">
  <!-- AdminLTE Skins. We have chosen the skin-blue for this starter
        page. However, you can choose any other skin. Make sure you
        apply the skin class to the body tag so the changes take effect.
  -->
  <link rel="stylesheet" href="{$ThemeDir}/dist/css/skins/skin-blue.min.css">
        ...
        <ul class="nav navbar-nav">
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image -->
                        <img src="{$ThemeDir}/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                      </div>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="{$ThemeDir}/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
...
<!-- jQuery 2.2.3 -->
<script src="{$ThemeDir}/plugins/jQuery/jquery-2.2.3.min.js"></script>
<!-- Bootstrap 3.3.6 -->
<script src="{$ThemeDir}/bootstrap/js/bootstrap.min.js"></script>
<!-- AdminLTE App -->
<script src="{$ThemeDir}/dist/js/app.min.js"></script>
